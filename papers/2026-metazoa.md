---
title: 系統・進化論文紹介2026（後生動物Metazoa）
description: 後生動物Metazoaの初期の系統・進化に関する2026年に出版された論文をなるべく網羅的に紹介しています
lang: ja_JP
---

# 系統・進化論文紹介2026（後生動物Metazoa）
...
An eye-popping discovery: early vertebrates had four eyes rather than two (Levine, 2026, *Nature*)  
[DOI](https://doi.org/10.1038/d41586-025-04096-z)

「マルチプルアライメントのアルゴリズムの包括的かつ体系的な文献レビュー」（オープンアクセス）  
A comprehensive systematic literature review of multiple sequence alignment algorithms (Sabonsolin & Lao, 2026, *Discover Computing*)  
[DOI](https://doi.org/10.1007/s10791-026-09911-3)

「『ゲノム系統学におけるconcordance factorの意味と測定』の訂正」（オープンアクセス）  
Correction to: The Meaning and Measure of Concordance Factors in Phylogenomics (2026, *Molecular Biology and Evolution*)  
[DOI](https://doi.org/10.1093/molbev/msag013)
...
「Dunn et al.によるeLetterへの返信」（eLetter・閲覧可能）  
Response to Dunn et al. eLetter (Steenwyk & King, 2026, *Science*)  
[DOI](https://doi.org/10.1126/science.adw9456#elettersSection)

「動物の起源を探るためのスマートフォンのアナロジー」（オープンアクセス）  
A smartphone analogy to explore the origin of animals (Ruiz-Trillo et al., 2026, *The EMBO Journal*)  
[DOI](https://doi.org/10.1038/s44318-026-00692-5)

「種系統樹推論に関する進化する見解」（オープンアクセス）  
An evolving view of species tree inference (Kubatko, 2026, *Systematic Biology*)  
[DOI](https://doi.org/10.1093/sysbio/syag002)
...
[DOI](https://doi.org/10.20944/preprints202601.1072.v1)
...
「厳密な秩序から急進的な多様化へ：あまり知られていない動物門（腹毛動物門）の主要系統におけるミトゲノムの進化」（オープンアクセス）  
From rigid order to radical variation: mitogenome evolution in the main lineages of a lesser-known animal phylum (Gastrotricha) (Kosakyan et al., 2026, *Genome Biology and Evolution*)  
[DOI](https://doi.org/10.1093/gbe/evag001)
...
「特異なタフォノミー条件下で保存された，オルドビス紀のカブトガニ類の体化石と生痕化石の共産」（オープンアクセス）  
Ordovician horseshoe crab body and trace fossil association preserved in a unique taphonomic setting (Bicknell et al., 2026, *Gondwana Research*)  
[DOI](https://doi.org/10.1016/j.gr.2025.11.011)

「Chromadoreaの分子系統により，中国・黄海産の2新種の記載を伴うDesmodoridaとMicrolaimidaの属の再分類が支持される」（オープンアクセス）  
Molecular phylogeny of Chromadorea supports genus reclassification of Desmodorida and Microlaimida with the description of two new species from the Yellow Sea, China (Meng & Wang, 2026, *Zoosystematics and Evolution*)  
[DOI](https://doi.org/10.3897/zse.102.170906)

「移行期にある盆地：カラハリクラトンのナマ層群におけるエディアカラン紀―カンブリア紀境界を通じた，生態・環境・テクトニクスの変遷」（オープンアクセス）  
A Basin in Transition: Ecological, Environmental, and Tectonic Shifts Across the Ediacaran–Cambrian Boundary in the Nama Group, Kalahari Craton (Nelson et al., 2026, *American Journal of Science*)  
[DOI](https://doi.org/10.2475/001c.151699)

「古代の遺伝子連鎖と超保存領域により，ダニ類の相互関係が解きほぐされる」（オープンアクセス）  
Ancient gene linkages and ultraconserved elements disentangle Acari interrelationships (Bhoi et al., 2025, *iScience*)  
[DOI](https://doi.org/10.1016/j.isci.2025.114616)

「中国北部からの後氷期のエディアカラン紀の大型化石群集の新産出および，その進化的意味合い」  
New occurrence of a postglacial Ediacaran macrofossil assemblage from North China and its evolutionary implication (Wang et al., 2026, *Precambrian Research*)  
[DOI](https://doi.org/10.1016/j.precamres.2025.107992)

「『超祖先』種およびサンプリングされた子孫の分布」（オープンアクセス）  
“Super-progenitor” species and the distribution of sampled descendants (Parins-Fukuchi, 2026, *Paleobiology*)  
[DOI](https://doi.org/10.1017/pab.2025.10083)

「エディアカラン紀からカンブリア紀への移行期における年代層序学的不確実性の総説」（プレプリント・閲覧可能）  
Reviewing chronostratigraphic uncertainty of the Ediacaran-Cambrian transition (Bowyer & Nelson, 2026 preprint, *EarthArXiv*)  
[DOI](https://doi.org/10.31223/X5FN1C)
