...
## 12月
「『統合ゲノム系統学により，海綿動物が動物系統樹の根に位置づけられる』の再考」（eLetter・閲覧可能）  
Re. Integrative phylogenomics positions sponges at the root of the animal tree (Dunn et al., 2025, *Science*)  
...
[URL](http://gswxb.cnjournals.cn/gswxb/article/abstract/20250301)

「ナミビア南部のエディアカラン紀末期のナマ層群からの，Dickinsoniomorpha類の可能性がある化石」（オープンアクセス）  
Possible dickinsoniomorphs from the latest Ediacaran Nama Group, southern Namibia (Gibson et al., 2025, *Precambrian Research*)  
[DOI](https://doi.org/10.1016/j.precamres.2025.107981)
...
「Weyland and Droser (2025) による『エディアカラン紀の水族館：ニルペナ・エディアカラ国立公園の1T-F海洋生態系（エディアカラ部層，Rawnsley珪岩）からの洞察』へのコメント」（オープンアクセス）  
Comment on ‘The Ediacaran aquarium: insights from the Nilpena Ediacara National Park 1T-F marine ecosystem (Ediacara member, Rawnsley Quartzite)’ by Weyland and Droser (2025) (Retallack, 2025, *Australian Journal of Earth Sciences*)  
[DOI](https://doi.org/10.1080/08120099.2025.2590157)

「Retallack (2025) による『エディアカラン紀の水族館：ニルペナ・エディアカラ国立公園の1T-F海洋生態系（エディアカラ部層，Rawnsley珪岩）からの洞察』へのコメントに対する返信」（オープンアクセス）  
Reply to comment by Retallack (2025) on ‘The Ediacaran aquarium: insights from the Nilpena Ediacara National Park 1T-F marine ecosystem (Ediacara member, Rawnsley Quartzite)’ (Weyland & Droser, 2025, *Australian Journal of Earth Sciences*)  
[DOI](https://doi.org/10.1080/08120099.2025.2590158)

「『統合ゲノム系統学』は誤差の要因を統合してしまっている」（eLetter・閲覧可能）  
“Integrative Phylogenomics” Integrates Sources of Error (Whelan, 2025, *Science*)  
[DOI](https://doi.org/10.1126/science.adw9456#elettersSection)
...
「地球における海綿動物の起源と進化：ハイブリッド型システマティック文献レビューおよび計量書誌学的解析」（国際会議論文・オープンアクセス）  
...
「18Sの系統的配置の正確性を評価し，初期に分岐した動物に潜む隠れた多様性を明らかにする」（プレプリント・閲覧可能）  
Evaluating 18S Phylogenetic Placement Accuracy to Uncover Hidden Diversity in Early Branching Animals (Arano-Ansola et al., 2025 preprint, *bioRxiv*)  
[DOI](https://doi.org/10.64898/2025.12.09.693319)
...
[ResearchGate全文PDF](https://www.researchgate.net/publication/398055634_A_Phylogenomic_Framework_of_Gastrotricha_Evolutionary_Relationships)
...
「統合ゲノム系統学により，海綿動物が動物系統樹の根に位置づけられる」（オープンアクセス）  
Integrative phylogenomics positions sponges at the root of the animal tree (Steenwyk & King, 2025, *Science*)  
[DOI](https://doi.org/10.1126/science.adw9456)

「ゲノム系統学的不一致を吸収除去する」（オープンアクセス）  
Sponging away phylogenomic incongruence (Mulhair & Redmond, 2025, *Science*)  
...
「ゲノム系統学により育児嚢を持つ甲殻類の単系統性が支持される：直接発生への道」（プレプリント・閲覧可能）  
Phylogenomics supports monophyly of marsupial crustaceans: a journey to direct development (Barta et al., 2025 preprint, *bioRxiv*)  
[DOI](https://doi.org/10.1101/2025.11.06.686749)
...
「系統解析における形質recoding法の尤度ベースの評価」（プレプリント・閲覧可能）  
Likelihood-based evaluation of character recoding schemes for phylogenetic analysis (Seo & Thorne, 2025 preprint, *bioRxiv*)  
[DOI](https://doi.org/10.1101/2025.10.15.682473)
...
[DOI](https://doi.org/10.5281/zenodo.17267994)
...
[DOI](https://doi.org/10.1126/science.ads0215#elettersSection)
